...
Original file is located at
    https://colab.research.google.com/drive/13R0t6MbrxP6yLzpTLxxV2UVJmMXnJ-md
...
class QA_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.split == "train":
            ...
            rand_range = self.max_paragraph_len//2 - ans_len//2

            # A single window is obtained by slicing the portion of paragraph containing the answer
            mid = (answer_start_token + answer_end_token) // 2 + random.randint(-rand_range, rand_range)
