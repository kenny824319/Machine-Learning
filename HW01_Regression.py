...
Original file is located at
    https://colab.research.google.com/drive/1yw2vAKVvUSG6DNfmyshbGv7phOSOIfPd
...
class NeuralNet(nn.Module):
    ...
    def cal_loss(self, pred, target):
        ...
        return torch.sqrt(self.criterion(pred, target))#+ l2_lamda * l2_reg
...
config = {
    ...
    'optim_hparas': {                # hyper-parameters for the optimizer (depends on which optimizer you are using)
        ...
        #'momentum': 0.8 
        'weight_decay':3e-3            # momentum for SGD
    },
